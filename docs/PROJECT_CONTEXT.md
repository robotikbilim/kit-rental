...
- QR label print text uses enlarged print-specific font sizes for improved readability on the fixed 60×30 mm label, while preserving the QR and label dimensions.
