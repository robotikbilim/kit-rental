...
namespace KitRental.Core.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260820222749_AddPublicFormAccessTokens")]
    partial class AddPublicFormAccessTokens
    {
        /// <inheritdoc />
                    ...
                    b.OwnsMany("KitRental.Core.Domain.Rentals.RentalCohortStudent", "Students", b1 =>
                        {
                            ...
                            b1.HasOne("KitRental.Core.Domain.Locations.LocationCity", null)
                                .WithMany()
                                .HasForeignKey("CityId")
                                .OnDelete(DeleteBehavior.Restrict);

                            b1.HasOne("KitRental.Core.Domain.Locations.LocationDistrict", null)
                                .WithMany()
